...
if __name__ == '__main__':
    ...
    while True:  # ensures continuous stream extraction
        ...
        try:
            ...
            l = StdOutListener()
            auth = OAuthHandler("Kvd5xWHMz8Z5rE6HJjQEUjFpS", "urNEK9BoNd3UOJiXPzjAOsmNqws04qRfOEXvyTINEFAfzL1Ihc")
            auth.set_access_token("49328121-jzDtXvD5UgqgkcXdGJ9xxID916h0qho1PZdWa0rsV", "NBj4DLKMfhTrydaj5FtVm74uXWE4JB3UJtxirWgfauvq2")
